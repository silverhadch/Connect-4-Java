...
public class Soundplayer extends GUI{
    ...
    private static final String SOUND_FILE_PATH = "resources/Backgroundsound.wav";
    private static final String SOUND_FILE_PATH2 = "resources/Winning Sound Effect.wav";
    private static final String SOUND_FILE_PATH3 = "resources/Sad Trombone - Sound Effect (HD).wav";
    ...
    static void playDrawandLoseMusic() {
        try {
